...
<script type="text/javascript">
	...
	function doSubmit() {
		...
		//校验结果
		doVerify();
		if (vResult) { //ajax 是 异步提交，里面的vResult值影响不到外面的vResult值，所以要设置同步操作，这里我们要搞清楚同步和异步的本质含义
			//提交表单
...
<body class="rightBody">
	<form id="form" name="form" action="${basePath }nsfw/user_edit.action"
					...
					<table id="baseInfo" width="100%" align="center" class="list"
						...
						<tr>
							...
							<td><s:if
									...
									<img
										src="${basePath }upload/<s:property value='user.headImg'/>"
