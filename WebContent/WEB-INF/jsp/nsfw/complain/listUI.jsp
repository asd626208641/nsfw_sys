...
<script type="text/javascript">
	...
	function doDeal(compId) {
		document.forms[0].action = "${basePath}nsfw/complain_dealUI.action?complain.compId="
				+ compId;
		document.forms[0].submit();
	}
</script>
						...
						<table width="100%" border="0">
							...
							<s:iterator value="pageResult.items" status="st">
								<tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if>>
									...
									<s:if test="#complainStateMap[state]=='已受理'">
										<td align="center" style="color: red"><s:property
												value="#complainStateMap[state]" /></td>
									</s:if>
									<s:else>
										<td align="center" style="color: green"><s:property
												value="#complainStateMap[state]" /></td>
									</s:else>
									<td align="center"> 
									    <s:if test="state!=2">
